...
public class CannonSubsystem extends SubsystemBase{
    ...
    public TalonFXSensorCollection topSensors;
    public TalonFXSensorCollection bottomSensors;
    ...
    public CannonSubsystem(){
        ...
        topSensors = topCannonMotor.getSensorCollection();
        bottomSensors = bottomCannonMotor.getSensorCollection();
    ...
    public double getTopSpeed() {
        return topSensors.getIntegratedSensorVelocity();
    }

    public double getBottomSpeed() {
        return bottomSensors.getIntegratedSensorVelocity();
    }
}
